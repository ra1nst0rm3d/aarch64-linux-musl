...
enum opt_code
{
  ...
  OPT_mbig_endian = 1155,                    /* -mbig-endian */
  OPT_mbionic = 1156,                        /* -mbionic */
  OPT_mcmodel_ = 1157,                       /* -mcmodel= */
  OPT_mcpu_ = 1158,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1159,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1160,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1161,             /* -mgeneral-regs-only */
  OPT_mglibc = 1162,                         /* -mglibc */
  OPT_mlittle_endian = 1163,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1164,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1165,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1166,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1167,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1168,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1169,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1170,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1171,          /* -msign-return-address= */
  OPT_mstrict_align = 1172,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1173,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1174,                     /* -mtls-size= */
  OPT_mtune_ = 1175,                         /* -mtune= */
  OPT_muclibc = 1176,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1177,             /* -mverbose-cost-dump */
  OPT_n = 1178,                              /* -n */
  OPT_no_canonical_prefixes = 1179,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1180,              /* -no-integrated-cpp */
  OPT_no_pie = 1181,                         /* -no-pie */
  OPT_nocpp = 1182,                          /* -nocpp */
  OPT_nodefaultlibs = 1183,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1184,                   /* -nostartfiles */
  OPT_nostdinc = 1185,                       /* -nostdinc */
  OPT_nostdinc__ = 1186,                     /* -nostdinc++ */
  OPT_nostdlib = 1187,                       /* -nostdlib */
  OPT_o = 1188,                              /* -o */
  OPT_p = 1189,                              /* -p */
  OPT_pass_exit_codes = 1190,                /* -pass-exit-codes */
  /* OPT_pedantic = 1191, */                 /* -pedantic */
  OPT_pedantic_errors = 1192,                /* -pedantic-errors */
  OPT_pg = 1193,                             /* -pg */
  OPT_pie = 1194,                            /* -pie */
  OPT_pipe = 1195,                           /* -pipe */
  OPT_posix = 1196,                          /* -posix */
  ...
  OPT_profile = 1208,                        /* -profile */
  OPT_pthread = 1209,                        /* -pthread */
  OPT_quiet = 1210,                          /* -quiet */
  OPT_r = 1211,                              /* -r */
  OPT_rdynamic = 1212,                       /* -rdynamic */
  OPT_remap = 1213,                          /* -remap */
  OPT_s = 1214,                              /* -s */
  OPT_save_temps = 1215,                     /* -save-temps */
  OPT_save_temps_ = 1216,                    /* -save-temps= */
  OPT_shared = 1217,                         /* -shared */
  OPT_shared_libgcc = 1218,                  /* -shared-libgcc */
  /* OPT_specs = 1219, */                    /* -specs */
  OPT_specs_ = 1220,                         /* -specs= */
  OPT_static = 1221,                         /* -static */
  OPT_static_libasan = 1222,                 /* -static-libasan */
  OPT_static_libgcc = 1223,                  /* -static-libgcc */
  ...
  OPT_time = 1273,                           /* -time */
  OPT_time_ = 1274,                          /* -time= */
  OPT_tno_android_cc = 1275,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1276,                 /* -tno-android-ld */
