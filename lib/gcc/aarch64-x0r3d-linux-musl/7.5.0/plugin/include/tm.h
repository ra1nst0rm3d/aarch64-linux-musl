#ifndef GCC_TM_H
#define GCC_TM_H
#define TARGET_CPU_DEFAULT (TARGET_CPU_generic | (((((  AARCH64_FL_FOR_ARCH8) | (0 | AARCH64_FL_CRC)) | (AARCH64_FL_FP | AARCH64_FL_SIMD)) | (AARCH64_FL_FP | AARCH64_FL_SIMD | AARCH64_FL_CRYPTO)) << 6))
#ifndef LIBC_GLIBC
# define LIBC_GLIBC 1
#endif
#ifndef LIBC_UCLIBC
